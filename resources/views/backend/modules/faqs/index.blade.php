                ...
                <tbody>
                    @foreach ($faqs as $faq)
                      <tr>
                        ...
                        <td>{{ $faq->title }}</td>
                        <td>
                          <a href="{{ backend_url($moduleProperties['controller'].'/edit/'.$faq->id) }}" title="Edit" class="btn btn-xs btn-primary">
                            <i class="fa fa-pencil"></i>
                          </a>

                          <a class="btn btn-xs btn-danger delete" type="button" title="Delete" data-toggle="modal" data-target="#deleteModal{{ $faq->id }}">
                              <i class="fa fa-trash"></i>
                          </a>

                          <div id="deleteModal{{ $faq->id }}" class="modal fade" role="dialog">
                              ...
                              {!! Form::model($faq, ['method' => 'delete', 'url' => 'backend/'.$moduleProperties['controller'].'/'.$faq->id, 'class' =>'form-inline form-delete']) !!}
