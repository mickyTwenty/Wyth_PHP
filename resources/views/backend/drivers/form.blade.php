...
<div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group {{ $errors->first('school_name', 'has-error') }}">
                {!! Form::label('school_name', 'College Name *') !!}
                {!! Form::select('school_name', [], null, ['class' => 'form-control']) !!}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group {{ $errors->first('graduation_year', 'has-error') }}">
                ...
                {!! Form::text('graduation_year', null, ['class' => 'form-control datepicker-year']) !!}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group {{ $errors->first('vehicle_id_number', 'has-error') }}">
                {!! Form::label('vehicle_id_number', 'License Plate No.') !!}
                {!! Form::text('vehicle_id_number', null, ['class' => 'form-control']) !!}
                {!! $errors->first('vehicle_id_number', '<span class="help-block">:message</span> ') !!}
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group {{ $errors->first('vehicle_make', 'has-error') }}">
                {!! Form::label('vehicle_make', 'Vehicle Make') !!}
                {!! Form::text('vehicle_make', null, ['class' => 'form-control']) !!}
                {!! $errors->first('vehicle_make', '<span class="help-block">:message</span> ') !!}
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="form-group {{ $errors->first('vehicle_model', 'has-error') }}">
                {!! Form::label('vehicle_model', 'Vehicle Model') !!}
                {!! Form::text('vehicle_model', null, ['class' => 'form-control']) !!}
                {!! $errors->first('vehicle_model', '<span class="help-block">:message</span> ') !!}
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="form-group {{ $errors->first('vehicle_year', 'has-error') }}">
                {!! Form::label('vehicle_year', 'Vehicle Year') !!}
                {!! Form::text('vehicle_year', null, ['class' => 'form-control datepicker-year']) !!}
                {!! $errors->first('vehicle_year', '<span class="help-block">:message</span> ') !!}
            </div>
        </div>
    </div>
</div>
...
@section('inlineJS')
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($) {
            var schoolUrl = '{{ route('find.school') }}';
            ...
            @if (old('school_name'))
                var schoolData = {
                    id: '{!! old('school_name') !!}',
                    text: '{!! old('school_name') !!}'
                };

                var newOption = new Option(schoolData.text, schoolData.id, false, false);
                $('#school_name').append(newOption).trigger('change');
            @endif

            @if (isset($record) && $record->school_name)
                var schoolData = {
                    id: '{{ $record->school_name }}',
                    text: '{{ $record->school_name }}'
                };
