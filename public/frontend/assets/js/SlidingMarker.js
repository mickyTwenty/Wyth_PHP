...
(function (root, factory) {
    ...
    function (root, $) {
        ...
        var defaultOptions = {
            ...
            duration: 1000,
            animateFunctionAdapter: function (marker, destPosition, easing, duration, complete) {
                if (!animateTo) {
        ...
        var decorates = function (childCtor, parentCtor) {
            ...
            $.extend(childCtor.prototype, {
                ...
                _setInstancePositionAnimated: function (position) {
                    ...
                    that.get("animateFunctionAdapter").call(null, that._instance, position, that.get("easing"), that.get("duration"), that.get("complete"));
                },
